				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tournament_name" value="<?php echo ($this->input->post('tournament_name') ? $this->input->post('tournament_name') : $tournament['tournament_name']); ?>" class="form-control" id="tournament_name" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tournament_year" value="<?php echo ($this->input->post('tournament_year') ? $this->input->post('tournament_year') : $tournament['tournament_year']); ?>" class="form-control" id="tournament_year" />
