          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<select name="group_name" class="form-control">
							...
							{
								$selected = ($group['group_id'] == $this->input->post('group_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						<label for="tournament_id" class="control-label"><span class="text-danger">*</span>Tournament Team</label>
						...
						<span class="text-danger"><?php echo form_error('tournament_team_id');?></span>
					</div>
					<div class="col-md-6">
						<label for="net_run_rate" class="control-label"><span class="text-danger">*</span>Net Run Rate</label>
						<input type="text" class="form-control" name="net_run_rate" value="<?php echo $this->input->post('net_run_rate'); ?>" />
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" name="points" value="<?php echo $this->input->post('points'); ?>" />
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" name="wins" value="<?php echo $this->input->post('wins'); ?>" />
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" name="losses" value="<?php echo $this->input->post('losses'); ?>" />
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" name="n/r" value="<?php echo $this->input->post('n/r'); ?>" />
